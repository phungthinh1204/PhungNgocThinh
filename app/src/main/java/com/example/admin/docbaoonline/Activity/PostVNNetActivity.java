...
public class PostVNNetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_vnnet);
        ...
        try {
            jsonPost = readPosts.execute(link.dantri()).get();
        ...
        adapterListPosts = new AdapterListPosts(PostVNNetActivity.this, R.layout.layout_post, posts);
        ...
        lvDataPost.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(PostVNNetActivity.this, i+"", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(PostVNNetActivity.this,ContentDetailsPosts.class);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.menuDocTrucTuyen:
                                Intent intent = new Intent(PostVNNetActivity.this, MainActivity.class);
                                startActivity(intent);
                                break;
                            case R.id.menuTinDaLuu:
                                Intent intent2 = new Intent(PostVNNetActivity.this, DocBaoOfflineActivity.class);
                                startActivity(intent2);
                                break;
                            case R.id.menuTuyChinh:
                                Intent intent1 = new Intent(PostVNNetActivity.this, SettingActivity.class);
