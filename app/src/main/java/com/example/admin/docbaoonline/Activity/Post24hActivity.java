...
public class Post24hActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post24h);
        ...
        try {
            jsonPost = data24h.execute(link.link24h()).get();
        ...
        adapterListPosts = new AdapterListPosts(Post24hActivity.this, R.layout.layout_post, posts);
        ...
        lvDataPost.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(Post24hActivity.this, i+"", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Post24hActivity.this,ContentDetailsPosts.class);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.menuDocTrucTuyen:
                                Intent intent = new Intent(Post24hActivity.this, MainActivity.class);
                                startActivity(intent);
                                break;
                            case R.id.menuTinDaLuu:
                                Intent intent2 = new Intent(Post24hActivity.this, DocBaoOfflineActivity.class);
                                startActivity(intent2);
                                break;
                            case R.id.menuTuyChinh:
                                Intent intent1 = new Intent(Post24hActivity.this, SettingActivity.class);
